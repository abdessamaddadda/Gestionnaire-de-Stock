    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="box box-danger">
                ...
                <div class="box-body">
                    <form action="{{ url('product-categories/update', $category->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" placeholder="Product category name" value="{{ $category->name }}">
                                </div>
                            </div>
                        </div>
